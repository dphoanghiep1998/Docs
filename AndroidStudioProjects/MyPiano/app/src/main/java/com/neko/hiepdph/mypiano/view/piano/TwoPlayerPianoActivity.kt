...
@AndroidEntryPoint
class TwoPlayerPianoActivity : BaseActivity<ActivityTwoPlayerPianoBinding>() {
    private var scrollProgress = 0
    private var scrollProgress1 = 0
    override fun getViewBinding(): ActivityTwoPlayerPianoBinding {
        return ActivityTwoPlayerPianoBinding.inflate(layoutInflater)
    }
